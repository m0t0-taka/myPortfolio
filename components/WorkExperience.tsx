...
export default function WorkExperience({}: Props) {
  return (
    ...
    >
      ...
      <div className="w-full mt-24 flex space-x-5 overflow-x-scroll p-10 snap-x snap-mandatory scrollbar scrollbar-track-gray-400/20 scrollbar-thumb-[#F7AB0A]/80">
